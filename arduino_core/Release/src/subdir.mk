...
src/%.o: ../src/%.cpp
	...
	avr-g++ -I"C:\Users\user\workspace\arduino_core\libraries" -I"C:\Users\user\workspace\arduino_core\src" -DUSB_VID=0x2341 -DUSB_PID=0x0043 -Wall -Os -ffunction-sections -fdata-sections -ffunction-sections -fdata-sections -funsigned-char -funsigned-bitfields -fno-exceptions -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
...
src/%.o: ../src/%.c
	...
	avr-gcc -I"C:\Users\user\workspace\arduino_core\src" -I"C:\Users\user\workspace\arduino_core\libraries" -DUSB_VID=0x2341 -DUSB_PID=0x0043 -Wall -Os -ffunction-sections -fdata-sections -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
